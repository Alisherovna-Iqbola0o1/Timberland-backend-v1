...
from .serializers import UserOrderCreateSerialzier, UserCartListCreateSerialzier, UserOrderListSerialzier, UserCartUpdateSerialzier
    ...
    def create(self, request, *args, **kwargs):
        ...
        if ser.is_valid(raise_exception=True):
            ...
            if not validate_cart:
                return Response(
                    {"error": "savatcha bo'sh xolatda buyurtma berib bo'lmaydi!"},
